...
public class KongraRainforestModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityRendererRegistry.register(KongraRainforestModEntities.TOUCAN, NoopRenderer::new);
        EntityRendererRegistry.register(KongraRainforestModEntities.JAGUAR, NoopRenderer::new);
        EntityRendererRegistry.register(KongraRainforestModEntities.TREE_FROG, NoopRenderer::new);
    }
